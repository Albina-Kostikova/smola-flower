...
export function CommentsSection({ noteId }: CommentsSectionProps) {
  ...
  return (
    <section className="bg-white rounded-2xl shadow-lg p-6 flex flex-col">
      <h2 className="cursive text-2xl mb-6 text-(--color-primary)">Комментарии</h2>
      ...
      <div className="border-t border-gray-100 pt-5 space-y-4">
        <h3 className="text-lg font-semibold text-gray-800">Написать комментарий</h3>
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-(--color-primary) focus:border-transparent transition-all"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-(--color-primary) focus:border-transparent transition-all resize-none"
          />
        </div>
